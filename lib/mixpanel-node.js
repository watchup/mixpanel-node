...
var create_client = function(token, config) {
    ...
    */
    ...
    metrics.post_request = function(endpoint, data, callback) {
        ...
        if (!data) {
            var err = new Error('`data` must be non-null');
            return callback(err);
        }
        ...
        request(options, function(error, response, body) {
            ...
            try {
                ...
                error = new Error('Mixpanel REST API returned an invalid JSON');
                console.error(error);
                return callback(error);
            }
            ...
            error = new Error('Mixpanel REST API returned an invalid JSON response');
            console.error(error);
            return callback(error);
        });
    };
